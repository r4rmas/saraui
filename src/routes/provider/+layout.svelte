<script lang="ts">
  import { loaderProps, notificationBreakpointDirection, notificationBreakpointDistance, notificationConfig, notificationIcons, notificationTransition, providerConfig } from "./displayableCodes.js"
